...
//          public void actionPerformed(ActionEvent e) { MovieFactory.getVideoProperty("about:Simulation"); }
//        });
...
//        });
	...
	private String getMenuText(String name) {
		...
		// else if (name.startsWith("xuggle_res:")) text = (String)
		// MovieFactory.getVideoProperty(name);
		else
					...
					if (command.equals(JFileChooser.APPROVE_SELECTION)) {
						...
						if (accesory.saveAsXML()) { // must end with ".xml"
							if (!selectedFilename.toLowerCase().endsWith(".xml")) {
								theFileChooser
										.setSelectedFile(new File(selectedFile.getParent(), selectedFilename + ".xml"));
								nameChanged = true;
							}
						} else { // anything but ".xml"
							if (selectedFilename.toLowerCase().endsWith(".xml")) {
								theFileChooser
										.setSelectedFile(new File(selectedFile.getParent(), selectedFilename + ".bin"));
								nameChanged = true;
							}
						}
						if (nameChanged) {
