...
//    }
	...
	public void _setParentComponent(String _parent) {
		_simulation.setParentComponent(_parent);
	}

	public boolean _saveImage(String _filename, String _element) {
		return _simulation.saveImage(_filename, _element);
	}
	...
	public boolean _saveVariables(String _filename, String _varList) {
		return _simulation.saveVariables(_filename, _varList);
	}
	...
	public boolean _saveText(String _filename, String _text) {
		return _simulation.saveText(_filename, _text);
	}

	public boolean _saveText(String _filename, String _annotation, String _text) {
		return _simulation.saveText(_filename, _annotation, _text);
	}
	...
	public boolean _readState(String _filename) {
		return _simulation.readState(_filename);
	}

	public boolean _readVariables(String _filename, String _varList) {
		return _simulation.readVariables(_filename, (java.net.URL) null, _varList);
	}

	public boolean _readVariables(String _filename, java.util.List<String> _varList) {
		return _simulation.readVariables(_filename, getCodeBase(), _varList);
	}

	public String _readText(String _filename) {
		return _simulation.readText(_filename);
	}

	public String _readText(String _filename, String _type) {
		return _simulation.readText(_filename, _type);
	}
	...
	public Object _getUserData(String _name) {
		return _model.getUserData(_name);
	}
	...
	public void _alert(String _panel, String _title, String _message) {
		_model._alert(_panel, _title, _message);
	}
